-- Simple judge schema update
-- Run this in your Supabase SQL Editor

-- Drop existing judges table if it exists (WARNING: This will delete all judge data)
-- DROP TABLE IF EXISTS judges CASCADE;

-- Create new simplified judges table
...
-- Create judge sessions table for authentication
